...
public class ProfilePictureView extends FrameLayout {
    ...
    public final void setProfileId(@Nullable String profileId2) {
        boolean force = false;
    ...
    private void sendImageRequest(boolean allowCachedResponse) {
        ImageRequest request = new ImageRequest.Builder(getContext(), ImageRequest.getProfilePictureUri(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new ImageRequest.Callback() {

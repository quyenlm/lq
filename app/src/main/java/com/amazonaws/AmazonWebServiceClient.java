...
public abstract class AmazonWebServiceClient {
    ...
    public void setEndpoint(String endpoint2) throws IllegalArgumentException {
    ...
    private URI toURI(String endpoint2) throws IllegalArgumentException {
    ...
    public void setRegion(Region region) throws IllegalArgumentException {
        ...
        if (region.isServiceSupported(serviceName2)) {
            ...
            serviceEndpoint = String.format("%s.%s.%s", new Object[]{serviceName2, region.getName(), region.getDomain()});
            log.info("{" + serviceName2 + ", " + region.getName() + "} was not found in region metadata, trying to construct an endpoint using the standard pattern for this region: '" + serviceEndpoint + "'.");
        }
    ...
    public final RequestMetricCollector findRequestMetricCollector(Request<?> req) {
        ...
        if (mc != null) {
            RequestMetricCollector requestMetricCollector = mc;
            return mc;
        }
        RequestMetricCollector mc2 = getRequestMetricsCollector();
        RequestMetricCollector requestMetricCollector2 = mc2;

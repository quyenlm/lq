...
public final class Region {
    ...
    public boolean hasHttpsEndpoint(String serviceName) {
        return this.httpsSupport.containsKey(serviceName) && this.httpsSupport.get(serviceName).booleanValue();
    }

    public boolean hasHttpEndpoint(String serviceName) {
        return this.httpSupport.containsKey(serviceName) && this.httpSupport.get(serviceName).booleanValue();
    }

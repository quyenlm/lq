...
public class GlobalSecondaryIndex implements Serializable {
    ...
    public GlobalSecondaryIndex withIndexName(String indexName2) {
        this.indexName = indexName2;
        return this;
    }
    ...
    public GlobalSecondaryIndex withKeySchema(KeySchemaElement... keySchema2) {
    ...
    public GlobalSecondaryIndex withKeySchema(Collection<KeySchemaElement> keySchema2) {

...
public class AwsHostNameUtils {
    ...
    public static String parseRegionName(URI endpoint) {
        return parseRegionName(endpoint.getHost(), (String) null);
    }
    ...
    private static String parseRegionNameByInternalConfig(String host) {
        for (HostRegexToRegionMapping mapping : InternalConfig.Factory.getInternalConfig().getHostRegexToRegionMappings()) {

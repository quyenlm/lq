...
public class TraceFileHelper {
        ...
        readTraceFile(str2, new b() {
            public final boolean a(String str, int i, String str2, String str3) {
                ...
                if (aVar.a > 0 && aVar.c > 0 && aVar.b != null) {
                    ...
                    aVar.d.put(str, new String[]{str2, str3, new StringBuilder().append(i).toString()});
                }
                return true;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x01a5, code lost:
        if (com.tencent.bugly.proguard.x.a(r0) == false) goto L_0x01a7;
     */
    ...
    public static void readTraceFile(java.lang.String r12, com.tencent.bugly.crashreport.crash.anr.TraceFileHelper.b r13) {
        ...
        L_0x013c:
            ...
            r1 = r7
        L_0x013e:
            boolean r2 = com.tencent.bugly.proguard.x.a(r0)     // Catch:{ all -> 0x01d2 }
        ...
        L_0x0147:
            ...
            com.tencent.bugly.proguard.x.d(r2, r3)     // Catch:{ all -> 0x01d2 }
            if (r1 == 0) goto L_0x0004

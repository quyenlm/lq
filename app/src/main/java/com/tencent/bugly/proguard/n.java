...
public final class n {
        ...
        try {
            ...
            if (c2 == null) {
                ...
                for (m mVar : c2) {
                    ...
                    if (mVar.c + TimeUtils.MILLIS_IN_DAY < currentTimeMillis) {
                        arrayList2.add(mVar);
                    }
                }
                ...
                if (arrayList.size() < 2) {
                    ...
                    a(i, c2);
                    z = false;
                } else if (arrayList.size() <= 0 || ((m) arrayList.get(arrayList.size() - 1)).c + TimeUtils.MILLIS_IN_DAY >= currentTimeMillis) {
                    z = true;
                } else {
                    c2.clear();
                    a(i, c2);
    ...
    public synchronized <T extends java.util.List<?>> T c(int r6) {
        /*
            ...
            android.content.Context r2 = r5.c     // Catch:{ Exception -> 0x003a }
            ...
            java.lang.StringBuilder r3 = r3.append(r6)     // Catch:{ Exception -> 0x003a }
        ...
        L_0x0026:
            ...
            java.lang.Object r0 = r2.readObject()     // Catch:{ IOException -> 0x007b, ClassNotFoundException -> 0x0079 }
            java.util.List r0 = (java.util.List) r0     // Catch:{ IOException -> 0x007b, ClassNotFoundException -> 0x0079 }
        ...
        L_0x003a:
            ...
            com.tencent.bugly.proguard.x.e(r0, r2)     // Catch:{ all -> 0x0055 }
        L_0x0043:
            r0 = r1
            goto L_0x0024
        L_0x0045:
        ...
        L_0x0047:
            ...
            com.tencent.bugly.proguard.x.a(r2, r3)     // Catch:{ all -> 0x0075 }
        ...
        L_0x005a:
            ...
            r3 = 0
            java.lang.Object[] r3 = new java.lang.Object[r3]     // Catch:{ all -> 0x0071 }
            com.tencent.bugly.proguard.x.a(r0, r3)     // Catch:{ all -> 0x0071 }
    ...
    public synchronized <T extends java.util.List<?>> void a(int r5, T r6) {
        ...
        L_0x0032:
            ...
            com.tencent.bugly.proguard.x.e(r0, r1)     // Catch:{ all -> 0x003c }
            goto L_0x0003
        L_0x003c:
            r0 = move-exception
            monitor-exit(r4)
        ...
        L_0x0041:
            ...
            com.tencent.bugly.proguard.x.a(r0, r2)     // Catch:{ all -> 0x005a }

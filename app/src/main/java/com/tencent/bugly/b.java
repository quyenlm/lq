                    ...
                    if (buglyStrategy != null) {
                        ...
                        if (!TextUtils.isEmpty(appVersion)) {
                            if (appVersion.length() > 100) {
                                ...
                                x.d("appVersion %s length is over limit %d substring to %s", appVersion, 100, str5);
                            } else {
                                str5 = appVersion;
                            }
                            a3.j = str5;
                            ...
                            if (buglyStrategy.isReplaceOldChannel()) {
                                ...
                                if (!TextUtils.isEmpty(appChannel)) {
                                    if (appChannel.length() > 100) {
                                        ...
                                        x.d("appChannel %s length is over limit %d substring to %s", appChannel, 100, substring);
                                        str4 = substring;
                                    } else {
                                        str4 = appChannel;
                                    }
                                    d.a((int) BasePlatformConst.ACTION_DOWNLOAD_CORE_PLUGIN_SUCCESS, "app_channel", str4.getBytes(), (o) null, false);
                                    a3.l = str4;
                                }
                            } else {
                                Map<String, byte[]> a6 = d.a((int) BasePlatformConst.ACTION_DOWNLOAD_CORE_PLUGIN_SUCCESS, (o) null, true);
                        ...
                        if (!TextUtils.isEmpty(appPackageName)) {
                            if (appPackageName.length() > 100) {
                                ...
                                x.d("appPackageName %s length is over limit %d substring to %s", appPackageName, 100, str3);
                            } else {
                                str3 = appPackageName;
                            }
                            a3.c = str3;
                        ...
                        if (deviceID != null) {
                            if (deviceID.length() > 100) {
                                ...
                                x.d("deviceId %s length is over limit %d substring to %s", deviceID, 100, str2);
                            } else {
                                str2 = deviceID;
                            }
                            a3.c(str2);
                            x.a("[param] Set device ID: %s", str2);
                        }

...
public class IMRetCode {
    ...
    public static final int NOT_INITIALIZED = 17;
    public static final int NO_CHANNEL = 18;
    public static final int NO_PACKAGE = 9;
    ...
    public static IMResult buildSuccess() {
        return rebuildForSuccess(new IMResult(IMErrorDef.SUCCESS));
    }

    public static IMResult buildCancel() {
        IMResult imResult = new IMResult(IMErrorDef.CANCELED);

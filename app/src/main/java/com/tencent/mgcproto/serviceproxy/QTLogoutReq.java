...
public final class QTLogoutReq extends Message {
    ...
    public QTLogoutReq(ByteString openid2, ByteString uuid2, ByteString qt_token2, ByteString machine_code2) {
        this.openid = openid2;
        this.uuid = uuid2;
    ...
    private QTLogoutReq(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof QTLogoutReq)) {
            return false;
        }
        QTLogoutReq o = (QTLogoutReq) other;
    ...
    public static final class Builder extends Message.Builder<QTLogoutReq> {
        ...
        public Builder(QTLogoutReq message) {
            super(message);
            if (message != null) {

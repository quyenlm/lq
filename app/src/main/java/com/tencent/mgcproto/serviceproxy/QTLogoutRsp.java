...
public final class QTLogoutRsp extends Message {
    ...
    public QTLogoutRsp(Integer result2, String errMsg2) {
        this.result = result2;
        this.errMsg = errMsg2;
    }

    private QTLogoutRsp(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof QTLogoutRsp)) {
            return false;
        }
        QTLogoutRsp o = (QTLogoutRsp) other;
    ...
    public static final class Builder extends Message.Builder<QTLogoutRsp> {
        ...
        public Builder(QTLogoutRsp message) {
            super(message);
            if (message != null) {
        ...
        public QTLogoutRsp build() {
            checkRequiredFields();
            return new QTLogoutRsp(this);
        }
    }
}

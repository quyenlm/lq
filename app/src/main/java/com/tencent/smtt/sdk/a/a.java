...
public class a {
    public static final byte[] a = {98, -24, 57, -84, -115, 117, 55, 121};
    public static final byte[] b = {-25, -101, -115, 1, 47, 7, -27, -59, 18, Byte.MIN_VALUE, 123, 79, -44, 37, 46, 115};
    public static final byte[] c = {37, -110, 60, Byte.MAX_VALUE, 42, -27, -17, -110};
    ...
    private static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        int[][] iArr8 = (int[][]) Array.newInstance(Integer.TYPE, new int[]{8, 6});
        int[] iArr9 = new int[8];
        ...
        for (int i5 = 0; i5 < 48; i5++) {
            iArr7[i5] = iArr4[j[i5] - 1];
            iArr7[i5] = iArr7[i5] + iArr2[i2][i5];
            if (iArr7[i5] == 2) {
                iArr7[i5] = 0;
            }
        }
        ...
        while (true) {
            ...
            for (int i8 = 0; i8 < 6; i8++) {
                iArr8[i7][i8] = iArr7[(i7 * 6) + i8];
            }
            iArr9[i7] = l[i7][(iArr8[i7][0] << 1) + iArr8[i7][5]][(iArr8[i7][1] << 3) + (iArr8[i7][2] << 2) + (iArr8[i7][3] << 1) + iArr8[i7][4]];
            for (int i9 = 0; i9 < 4; i9++) {
                iArr10[((i7 * 4) + 3) - i9] = iArr9[i7] % 2;
                iArr9[i7] = iArr9[i7] / 2;
            }
            i6 = i7 + 1;
        }
        for (int i10 = 0; i10 < 32; i10++) {
            iArr11[i10] = iArr10[k[i10] - 1];
            iArr5[i10] = iArr4[i10];
    ...
    private static void a(int[] iArr, int[][] iArr2) {
        ...
        for (int i2 = 0; i2 < 56; i2++) {
            iArr3[i2] = iArr[h[i2] - 1];
        }
        for (int i3 = 0; i3 < 16; i3++) {
            a(iArr3, m[i3]);
            for (int i4 = 0; i4 < 48; i4++) {
                iArr2[i3][i4] = iArr3[i[i4] - 1];
            }
        }
    }
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, int i2) {
        ...
        try {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                System.arraycopy(b2, i4 * 8, bArr5, 0, 8);
                System.arraycopy(b(bArr4, bArr5, i2), 0, bArr3, i4 * 8, 8);
            }
            if (i2 == 0) {
                byte[] bArr6 = new byte[bArr2.length];
                System.arraycopy(bArr3, 0, bArr6, 0, bArr6.length);
                byte b3 = bArr6[bArr6.length - 1];
                if (b3 > 0 && b3 <= 8) {
                    int i5 = 0;
                    while (true) {
                        if (i5 >= b3) {
                            z = true;
                            break;
                        } else if (b3 != bArr6[(bArr6.length - 1) - i5]) {
                            break;
                        } else {
                            i5++;
                        }
                    ...
                    if (z) {
                        bArr3 = new byte[(bArr6.length - b3)];
    ...
    private static int[] a(byte[] r8) {
        ...
        L_0x0041:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.a.a.a(byte[]):int[]");
    }
    ...
    private static byte[] b(byte[] bArr, byte[] bArr2, int i2) {
        if (bArr.length == 8 && bArr2.length == 8 && (i2 == 1 || i2 == 0)) {
            ...
            int[][] iArr3 = (int[][]) Array.newInstance(Integer.TYPE, new int[]{16, 48});
            int[] a2 = a(bArr);
            int[] a3 = a(bArr2);
            a(a2, iArr3);
            return a(a3, i2, iArr3);
        }

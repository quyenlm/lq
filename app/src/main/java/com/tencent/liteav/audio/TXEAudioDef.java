...
public class TXEAudioDef {
    ...
    public static int TXE_AUDIO_JITTER_STATE_FIRST_PLAY = 2;
    public static int TXE_AUDIO_JITTER_STATE_LOADING = 0;
    public static int TXE_AUDIO_JITTER_STATE_PLAYING = 1;
    ...
    public static int TXE_AUDIO_PLAY_ERR_INVALID_STATE = -101;
    ...
    public static int TXE_AUDIO_PLAY_ERR_START_HW_DECODEC_FAILED = -103;
    public static int TXE_AUDIO_RECORD_ERR_CAPTURE_DATA_INVALID = -4;
    public static int TXE_AUDIO_RECORD_ERR_CUR_PLAYER_INVALID = -5;
    public static int TXE_AUDIO_RECORD_ERR_CUR_RECORDER_INVALID = NetworkBindingListener.NB_PREPARE_GEN_FD_FAIL;

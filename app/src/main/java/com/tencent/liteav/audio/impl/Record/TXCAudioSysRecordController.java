...
public class TXCAudioSysRecordController extends c implements g, d {
    ...
    public int startRecord(Context context) {
        ...
        if (!this.mIsCustomRecord) {
            if (this.mAECType == TXEAudioDef.TXE_AEC_SYSTEM) {
                if (this.mSampleRate > com.tencent.liteav.basic.e.b.a().c()) {
                    this.mRecordSampleRate = com.tencent.liteav.basic.e.b.a().d();
                } else {
                    this.mRecordSampleRate = com.tencent.liteav.basic.e.b.a().c();
                }
    ...
    public synchronized void onAudioRecordError(int i, String str) {
        ...
        f.a().a((g) null);
        uninitEffectAndEnc();
        if (!(this.mWeakRecordListener == null || (eVar = (e) this.mWeakRecordListener.get()) == null)) {
            eVar.a(i, str);
        }
    }
            ...
            if (this.mHWEcoder == null) {
                ...
                do {
                    ...
                    if (nativeReadOneFrame != null) {
                        this.mLastPTS = j4;
                        if (this.mHWEcoder != null) {
                            doHWEncode(nativeReadOneFrame, j4);
                        } else {
                            e listener2 = getListener();
                            if (listener2 != null) {
                                listener2.b(nativeReadOneFrame, j4, this.mSampleRate, this.mChannels, this.mBits);
                            }
                        }
                    }
                    j4 += (long) (1024000 / this.mSampleRate);

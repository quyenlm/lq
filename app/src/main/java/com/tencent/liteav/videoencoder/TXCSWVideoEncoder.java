...
public class TXCSWVideoEncoder extends b {
    ...
    public long mNativeX264Encoder = 0;
    /* access modifiers changed from: private */
    public long mPTS = 0;
    ...
    private static class a extends b {
        ...
        public a() {
            super("attribute vec4 position;\nattribute vec4 inputTextureCoordinate;\n \nvarying vec2 textureCoordinate;\n \nvoid main()\n{\n    gl_Position = position;\n    textureCoordinate = inputTextureCoordinate.xy;\n}", TXCSWVideoEncoder.FRAGMENT_SHADER_STR_RGB2YUV420P);
            a(true);
        }
    ...
    public long pushVideoFrame(final int i, int i2, int i3, long j) {
        if (this.mGLContextExternal != null) {
            ...
            if (this.mRawFrameFilter == null) {
                ...
                this.mRawFrameFilter.a((b.a) new b.a() {
                    public void a(int i) {
                        iArr[0] = TXCSWVideoEncoder.this.nativeEncode(TXCSWVideoEncoder.this.mNativeX264Encoder, i, TXCSWVideoEncoder.this.mOutputWidth, TXCSWVideoEncoder.this.mOutputHeight, TXCSWVideoEncoder.this.mPTS);
                    }
                });
            }
            if (this.mRawFrameFilter == null) {

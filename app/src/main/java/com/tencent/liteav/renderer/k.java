...
public class k {
    ...
    public void a(int i2, int i3) {
        if (i2 != this.c || i3 != this.d) {
            TXCLog.d("TXTweenFilter", "Output resolution change: " + this.c + "*" + this.d + " -> " + i2 + "*" + i3);
            this.c = i2;
            this.d = i3;
            if (i2 > i3) {
    ...
    public void b(int i2, int i3) {
        if (i2 != this.e || i3 != this.f) {
            TXCLog.d("TXTweenFilter", "Input resolution change: " + this.e + "*" + this.f + " -> " + i2 + "*" + i3);
            this.e = i2;
            this.f = i3;
        }
    }
    ...
    private void b(float[] fArr) {
        if (this.d != 0 && this.c != 0) {
            ...
            float f2 = (((float) this.c) * 1.0f) / ((float) i2);
            float f3 = (((float) this.d) * 1.0f) / ((float) i3);
            if (this.g == a) {
                if (((float) i3) * f2 <= ((float) this.d)) {
                    f2 = f3;
                }
            } else if (((float) i3) * f2 > ((float) this.d)) {
                f2 = f3;
            }
            Matrix.setIdentityM(this.k, 0);
            if (this.i) {
                if (this.h % ShareConstants.ERROR_CODE.GG_RESULT_UNKNOWN_ERROR == 0) {
                    Matrix.scaleM(this.k, 0, -1.0f, 1.0f, 1.0f);
                } else {
                    Matrix.scaleM(this.k, 0, 1.0f, -1.0f, 1.0f);
                }
            }
            Matrix.scaleM(this.k, 0, ((((float) i2) * f2) / ((float) this.c)) * 1.0f, ((((float) i3) * f2) / ((float) this.d)) * 1.0f, 1.0f);

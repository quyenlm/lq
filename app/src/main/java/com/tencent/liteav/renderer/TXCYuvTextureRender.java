...
public class TXCYuvTextureRender {
    ...
    public void drawFrame(long j) {
        ...
        if (!(this.mVideoWidth % 8 == 0 || (i2 = ((this.mVideoWidth + 7) / 8) * 8) == 0)) {
            Matrix.scaleM(this.mTextureMatrix, 0, (((float) (this.mVideoWidth - 1)) * 1.0f) / ((float) i2), 1.0f, 1.0f);
        }
        if (!(this.mVideoHeight % 8 == 0 || (i = ((this.mVideoHeight + 7) / 8) * 8) == 0)) {

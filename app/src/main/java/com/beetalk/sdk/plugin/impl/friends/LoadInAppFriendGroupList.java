        ...
        try {
            ...
            AsyncHttpClient.getInstance().getJSONObject(builder.build(), new AsyncHttpClient.JSONObjectCallback() {
                public void onCompleted(Exception e, AsyncHttpResponse source, JSONObject result) {
                    GGErrorCode resultCode = LoadInAppFriendGroupList.this.getResponseCode(result);
                    ...
                    GGPluginManager.getInstance().publishResult(ret, activity, LoadInAppFriendGroupList.this.getId());
                }
            });
        } catch (Exception e) {
            BBLogger.e(e);

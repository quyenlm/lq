...
public class GasTextSharePlugin extends GGPlugin<GGTextShare, PluginResult> {
    public String getId() {
        return SDKConstants.PLUGIN_KEYS.GAS_SHARE_TEXT;
    }

    public Integer getRequestCode() {
        return SDKConstants.PLUGIN_REQUEST_CODES.GAS_SHARE_TEXT;
    }
    ...
    public void executeAction(Activity activity, GGTextShare data) {
        if (data == null) {
            ...
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_TITLE, data.getTitle());
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_URL, "");
            ...
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_DESC, data.getDesc());
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_ITEM_TYPE, 0);
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_SHARE_TO, data.getScene());
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_IMG_DATA, data.getThumbData());
            intent.putExtra(SDKConstants.SHARE_BUNDLE_TAG.COM_GARENA_MSDK_GAME_SHARE_IMG_DATA_LEN, data.getThumDataLength());

    ...
    public static Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
        ...
        if ((toResolve instanceof Class) && ((Class) toResolve).isArray()) {
            ...
            if (componentType2 != newComponentType2) {
                original3 = arrayOf(newComponentType2);
            }
            Type type3 = toResolve;
            return original3;
            ...
            if (changed) {
                original4 = newParameterizedTypeWithOwner(newOwnerType, original4.getRawType(), args);
            }
            Type type4 = toResolve;
            return original4;
            ...
            if (originalLowerBound.length == 1) {
                ...
                if (lowerBound != originalLowerBound[0]) {
                    Type type5 = toResolve;
                    return supertypeOf(lowerBound);
                }
            } else if (originalUpperBound.length == 1) {
                Type upperBound = resolve(context, contextRawType, originalUpperBound[0]);
                if (upperBound != originalUpperBound[0]) {
                    Type type6 = toResolve;

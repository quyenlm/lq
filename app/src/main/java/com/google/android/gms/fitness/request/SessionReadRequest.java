...
public class SessionReadRequest extends zza {
    ...
    public static class Builder {
        ...
        /* access modifiers changed from: private */
        public List<String> zzaXl = new ArrayList();
        /* access modifiers changed from: private */
        public long zzagZ = 0;

        public SessionReadRequest build() {
            zzbo.zzb(this.zzagZ > 0, "Invalid start time: %s", Long.valueOf(this.zzagZ));
            zzbo.zzb(this.zzaTo > 0 && this.zzaTo > this.zzagZ, "Invalid end time: %s", Long.valueOf(this.zzaTo));
        ...
        public Builder excludePackage(String str) {
            zzbo.zzb(str, (Object) "Attempting to use a null package name");
    ...
    private SessionReadRequest(Builder builder) {
        this(builder.zzaXj, builder.mSessionId, builder.zzagZ, builder.zzaTo, builder.zzaTn, builder.zzaWr, builder.zzaXk, builder.zzaWC, builder.zzaXl, (zzbxa) null);
    }
    ...
    public String toString() {
        return zzbe.zzt(this).zzg("sessionName", this.zzaXj).zzg(UnityPayHelper.SESSIONID, this.mSessionId).zzg("startTimeMillis", Long.valueOf(this.zzagZ)).zzg("endTimeMillis", Long.valueOf(this.zzaTo)).zzg("dataTypes", this.zzaTn).zzg("dataSources", this.zzaWr).zzg("sessionsFromAllApps", Boolean.valueOf(this.zzaXk)).zzg("excludedPackages", this.zzaXl).zzg("useServer", Boolean.valueOf(this.zzaWC)).toString();
    }

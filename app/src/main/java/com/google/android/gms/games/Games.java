...
public final class Games {
    ...
    private static final Api.zza<GamesClientImpl, GamesOptions> zzaYm = new zzc();
    ...
    private static final Api.zza<GamesClientImpl, GamesOptions> zzajS = new zzb();
    ...
    public static final class GamesOptions implements GoogleSignInOptionsExtension, Api.ApiOptions.Optional {
        ...
        public static final class Builder {
            ...
            public final GamesOptions build() {
                return new GamesOptions(false, this.zzaYv, this.zzaYw, false, this.zzaYy, (String) null, this.zzaYA, false, false, false, (zzb) null);
            }
        ...
        /* synthetic */ GamesOptions(boolean z, boolean z2, int i, boolean z3, int i2, String str, ArrayList arrayList, boolean z4, boolean z5, boolean z6, zzb zzb) {
            this(false, z2, i, false, i2, (String) null, arrayList, false, false, false);
        }

        public static Builder builder() {
            return new Builder((zzb) null);
        }
    ...
    static abstract class zzb extends Api.zza<GamesClientImpl, GamesOptions> {
        ...
        public final /* synthetic */ Api.zze zza(Context context, Looper looper, zzq zzq, Object obj, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
            ...
            return new GamesClientImpl(context, looper, zzq, gamesOptions == null ? new GamesOptions.Builder((zzb) null).build() : gamesOptions, connectionCallbacks, onConnectionFailedListener);
        }
    }
    ...
    public static GamesClientImpl zzb(GoogleApiClient googleApiClient, boolean z) {
        zzbo.zza(googleApiClient.zza((Api<?>) API), (Object) "GoogleApiClient is not configured to use the Games Api. Pass Games.API into GoogleApiClient.Builder#addApi() to use this feature.");

...
public final class LocationRequest extends zza implements ReflectedParcelable {
    ...
    public LocationRequest() {
        this.mPriority = 102;
        this.zzbhX = 3600000;
        this.zzbhY = BATrackerConst.TRACKER_WAKE_UP_INTERVAL;
        this.zzaXd = false;
        this.zzbhG = FileTracerConfig.FOREVER;
    ...
    public final LocationRequest setExpirationDuration(long j) {
        ...
        if (j > FileTracerConfig.FOREVER - elapsedRealtime) {
            this.zzbhG = FileTracerConfig.FOREVER;
        } else {
            this.zzbhG = elapsedRealtime + j;
        }
        if (this.zzbhG < 0) {
            this.zzbhG = 0;
        }
    ...
    public final String toString() {
        ...
        if (this.mPriority != 105) {
            sb.append(" requested=");
            sb.append(this.zzbhX).append("ms");
        }
        sb.append(" fastest=");
        sb.append(this.zzbhY).append("ms");
        if (this.zzbib > this.zzbhX) {
            sb.append(" maxWait=");
            sb.append(this.zzbib).append("ms");
        }
        if (this.zzbia > 0.0f) {
            sb.append(" smallestDisplacement=");
            sb.append(this.zzbia).append("m");
        }
        if (this.zzbhG != FileTracerConfig.FOREVER) {
            sb.append(" expireIn=");
            sb.append(this.zzbhG - SystemClock.elapsedRealtime()).append("ms");
        }
        if (this.zzbhZ != Integer.MAX_VALUE) {
            sb.append(" num=").append(this.zzbhZ);
        }
        sb.append(']');
        return sb.toString();
    }

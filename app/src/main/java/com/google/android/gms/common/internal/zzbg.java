...
public final class zzbg {
    ...
    public final zzbg zzg(String str, Object obj) {
        ...
        list.add(new StringBuilder(String.valueOf(str2).length() + 1 + String.valueOf(valueOf).length()).append(str2).append(HttpRequest.HTTP_REQ_ENTITY_MERGE).append(valueOf).toString());
        return this;
    }
}

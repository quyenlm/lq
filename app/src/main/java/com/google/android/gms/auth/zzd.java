...
public class zzd {
    ...
    private static final String[] zzakl = {"com.google", "com.google.work", "cn.google"};
    ...
    public static final zzbgb zzakn = new zzbgb("Auth", "GoogleAuthUtil");
    ...
    private static <T> T zza(Context context, ComponentName componentName, zzi<T> zzi) throws IOException, GoogleAuthException {
        ...
        if (zzaC.zza(componentName, (ServiceConnection) zza, "GoogleAuthUtil")) {
            try {
                T zzy = zzi.zzy(zza.zzoV());
                zzaC.zzb(componentName, (ServiceConnection) zza, "GoogleAuthUtil");
                return zzy;
    ...
    public static TokenData zzb(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        return (TokenData) zza(context, zzakm, new zze(account, str, bundle2));
    }
    ...
    /* access modifiers changed from: private */
    public static <T> T zzl(T t) throws IOException {
        if (t != null) {
            return t;
        }

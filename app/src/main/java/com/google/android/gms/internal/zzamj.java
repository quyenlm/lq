...
public class zzamj {
    ...
    private zzamj(zzaml zzaml) {
        Context applicationContext = zzaml.getApplicationContext();
        ...
        zzae.zza((Thread.UncaughtExceptionHandler) new zzamk(this));
        this.zzafQ = zzae;
    ...
    private static void zza(zzamh zzamh) {
        zzbo.zzb(zzamh, (Object) "Analytics service not created/initialized");

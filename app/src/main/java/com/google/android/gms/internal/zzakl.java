...
final class zzakl implements Callable<zzaka> {
    ...
    public final /* synthetic */ Object call() throws Exception {
        zzakn zzakn = new zzakn(zzako.zzb(this.zztF, this.zzAG, this.zzabL, this.zzabM, this.zzLf, this.zzKO, this.zzabN, this.zzabO, this.zzKQ, this.zzabP));
        zzakn.setWebViewClient(zzbs.zzbB().zzb((zzaka) zzakn, this.zzabM));

...
public class UIMediaController implements SessionManagerListener<CastSession>, RemoteMediaClient.Listener {
    ...
    public final Set<zzawv> zzavj = new HashSet();
    ...
    public UIMediaController(Activity activity) {
        ...
        zza((Session) this.zzarO.getCurrentCastSession());
    }

    private final void zza(View view, UIController uIController) {
        List list = this.zzavi.get(view);
        if (list == null) {
            list = new ArrayList();
    ...
    public void bindImageViewToImageOfCurrentItem(ImageView imageView, int i, @DrawableRes int i2) {
        ...
        zza(imageView, new zzavw(imageView, this.mActivity, new ImageHints(i, 0, 0), i2, (View) null));
    }
    ...
    public void bindImageViewToImageOfCurrentItem(ImageView imageView, @NonNull ImageHints imageHints, @DrawableRes int i) {
        zzbo.zzcz("Must be called from the main thread.");
        zza(imageView, new zzavw(imageView, this.mActivity, imageHints, i, (View) null));
    }
    ...
    public void bindTextViewToStreamDuration(TextView textView) {
        zzbo.zzcz("Must be called from the main thread.");
        zza(textView, new zzawu(textView, this.mActivity.getString(R.string.cast_invalid_stream_duration_text), (View) null));
    }

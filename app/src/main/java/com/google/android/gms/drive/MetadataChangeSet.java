...
public final class MetadataChangeSet {
    ...
    public static class Builder {
        ...
        private static void zzi(String str, int i, int i2) {
            zzbo.zzb(i2 <= i, (Object) String.format("%s must be no more than %d bytes, but is %d bytes.", new Object[]{str, Integer.valueOf(i), Integer.valueOf(i2)}));
        }
        ...
        public Builder deleteCustomProperty(CustomPropertyKey customPropertyKey) {
            ...
            zzsX().zza(customPropertyKey, (String) null);
            return this;
        }

        public Builder setCustomProperty(CustomPropertyKey customPropertyKey, String str) {
            zzbo.zzb(customPropertyKey, (Object) "key");
            zzbo.zzb(str, (Object) "value");
            zzi("The total size of key string and value string of a custom property", 124, zzcP(customPropertyKey.getKey()) + zzcP(str));

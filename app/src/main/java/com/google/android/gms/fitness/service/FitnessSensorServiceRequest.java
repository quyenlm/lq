...
public class FitnessSensorServiceRequest extends zza {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!(zzbe.equal(this.zzaUd, fitnessSensorServiceRequest.zzaUd) && this.zzaXE == fitnessSensorServiceRequest.zzaXE && this.zzaXF == fitnessSensorServiceRequest.zzaXF)) {
                return false;
            }
        }
        return true;
    ...
    public long getSamplingRate(TimeUnit timeUnit) {
        ...
        return timeUnit.convert(this.zzaXE, TimeUnit.MICROSECONDS);
    }

...
public class Barcode extends zza {
    ...
    public static class CalendarEvent extends zza {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            zzd.zza(parcel, 7, (Parcelable) this.start, i, false);
            zzd.zza(parcel, 8, (Parcelable) this.end, i, false);
            zzd.zzI(parcel, zze);
        }
    }
    ...
    public static class ContactInfo extends zza {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            int zze = zzd.zze(parcel);
            zzd.zza(parcel, 2, (Parcelable) this.name, i, false);
            zzd.zza(parcel, 3, this.organization, false);
            zzd.zza(parcel, 4, this.title, false);
            zzd.zza(parcel, 5, (T[]) this.phones, i, false);
            zzd.zza(parcel, 6, (T[]) this.emails, i, false);
            zzd.zza(parcel, 7, this.urls, false);
            zzd.zza(parcel, 8, (T[]) this.addresses, i, false);
            zzd.zzI(parcel, zze);
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 6, (T[]) this.cornerPoints, i, false);
        zzd.zza(parcel, 7, (Parcelable) this.email, i, false);
        zzd.zza(parcel, 8, (Parcelable) this.phone, i, false);
        zzd.zza(parcel, 9, (Parcelable) this.sms, i, false);
        zzd.zza(parcel, 10, (Parcelable) this.wifi, i, false);
        zzd.zza(parcel, 11, (Parcelable) this.url, i, false);
        zzd.zza(parcel, 12, (Parcelable) this.geoPoint, i, false);
        zzd.zza(parcel, 13, (Parcelable) this.calendarEvent, i, false);
        zzd.zza(parcel, 14, (Parcelable) this.contactInfo, i, false);
        zzd.zza(parcel, 15, (Parcelable) this.driverLicense, i, false);
        zzd.zzI(parcel, zze);
    }
}

...
public final class to extends qi {
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof to) && ((to) obj).zzcfr.equals(this.zzcfr) && ((to) obj).zzbYY.equals(this.zzbYY) && ((to) obj).zzccD.equals(this.zzccD);
    }
    ...
    public final vj zza(vi viVar, vt vtVar) {
        return new vj(vl.VALUE, this, zzh.zza(zzh.zza(this.zzbYY, vtVar.zzFq()), viVar.zzHW()), (String) null);
    }

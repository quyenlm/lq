...
public final class zzbs implements RealTimeMultiplayer {
    ...
    public final void create(GoogleApiClient googleApiClient, RoomConfig roomConfig) {
        ...
        if (zza != null) {
            zza.zza((zzbdw<RoomUpdateListener>) googleApiClient.zzp(roomConfig.getRoomUpdateListener()), (zzbdw<RoomStatusUpdateListener>) zza(googleApiClient, roomConfig.getRoomStatusUpdateListener()), (zzbdw<RealTimeMessageReceivedListener>) zza(googleApiClient, roomConfig.getMessageReceivedListener()), roomConfig);
        }
    }
    ...
    public final void leave(GoogleApiClient googleApiClient, RoomUpdateListener roomUpdateListener, String str) {
        GamesClientImpl zza = Games.zza(googleApiClient, false);
        if (zza != null) {
            zza.zza((zzbdw<RoomUpdateListener>) googleApiClient.zzp(roomUpdateListener), str);
        }
    }
    ...
    public final int sendReliableMessage(GoogleApiClient googleApiClient, RealTimeMultiplayer.ReliableMessageSentCallback reliableMessageSentCallback, byte[] bArr, String str, String str2) {
        return Games.zzf(googleApiClient).zza((zzbdw<RealTimeMultiplayer.ReliableMessageSentCallback>) zza(googleApiClient, reliableMessageSentCallback), bArr, str, str2);
    }

...
public final class zzapj {
    ...
    public final zzapi zzml() {
        ...
        return new zzapi(this.mName, this.zzajx, this.zzajy, this.zzajz, this.zzajA, (String) null, (zzapd[]) this.zzajB.toArray(new zzapd[this.zzajB.size()]), iArr, this.zzajD);
    }
}

...
public enum zzbg {
    ...
    COMPONENT(CompetitiveBootStrategy.INTENT_COMPONENT_NAME),
    ...
    JAVASCRIPT(ContentType.SUBTYPE_JAVASCRIPT),
    JSON("json"),
    KEYWORD("keyword"),
    ...
    OPTOUT("optout"),
    ORDER(APNetworkManager2.HTTP_KEY_OVERSEAORDER),
    ORDER_ID("order_id"),

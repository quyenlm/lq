...
public final class GooglePlayServicesUtil extends zzo {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zza = GoogleApiAvailability.zza((Context) activity, i, zzt.zza(fragment, zze.zza(activity, i, APDataReportManager.GOODSANDMONTHSINPUT_PRE), i2), onCancelListener);
        if (zza == null) {
            return false;
        }

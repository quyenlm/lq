...
final class zzc implements Runnable {
    ...
    final /* synthetic */ JavascriptEngineFactory.JSEngineSettableFuture zzKR;
    private /* synthetic */ String zzKS;
    private /* synthetic */ Context zztF;

    zzc(JavascriptEngineFactory javascriptEngineFactory, Context context, zzaje zzaje, zzcu zzcu, zzv zzv, JavascriptEngineFactory.JSEngineSettableFuture jSEngineSettableFuture, String str) {
        this.zztF = context;
        this.zzKO = zzaje;
        this.zzKP = zzcu;
        this.zzKQ = zzv;

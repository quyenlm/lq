...
public class MiniControllerFragment extends Fragment implements ControlButtonsContainer {
    ...
    private final void zza(RelativeLayout relativeLayout, int i, int i2) {
        ...
        if (i4 == R.id.cast_button_type_empty) {
            ...
            if (i4 == R.id.cast_button_type_play_pause_toggle) {
                ...
                Drawable zza = zzb.zza(getContext(), this.zzaws, i5);
                Drawable zza2 = zzb.zza(getContext(), this.zzaws, i3);
                Drawable zza3 = zzb.zza(getContext(), this.zzaws, i7);
                ...
                if (!(this.zzawL == 0 || indeterminateDrawable == null)) {
                    indeterminateDrawable.setColorFilter(this.zzawL, PorterDuff.Mode.SRC_IN);
                }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.zzawL != 0) {
            ((LayerDrawable) progressBar.getProgressDrawable()).setColorFilter(this.zzawL, PorterDuff.Mode.SRC_IN);
        }

...
public final class zzno extends RelativeLayout {
    private static final float[] zzHx = {5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f, 5.0f};
    @Nullable
    private AnimationDrawable zzHy;

    public zzno(Context context, zznn zznn, RelativeLayout.LayoutParams layoutParams) {
        super(context);
        zzbo.zzu(zznn);
        ShapeDrawable shapeDrawable = new ShapeDrawable(new RoundRectShape(zzHx, (RectF) null, (float[]) null));

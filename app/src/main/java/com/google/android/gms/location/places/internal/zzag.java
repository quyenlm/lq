...
public final class zzag extends zza implements PlaceLikelihood {
    ...
    public final String toString() {
        return zzbe.zzt(this).zzg(VKApiCommunityFull.PLACE, this.zzbkI).zzg("likelihood", Float.valueOf(this.zzbkJ)).toString();
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int zze = zzd.zze(parcel);
        zzd.zza(parcel, 1, (Parcelable) this.zzbkI, i, false);

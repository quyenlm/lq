...
public final class zzcec extends zzchi {
        ...
        if (num != null) {
            ...
            if (intValue == 0) {
                ...
                if (l == null) {
                    ...
                    zza(str, j - l.longValue(), (AppMeasurement.zzb) zzzh);
                }
                if (!this.zzbor.isEmpty()) {
                    return;
                }
                ...
                zza(j - this.zzbos, (AppMeasurement.zzb) zzzh);
                this.zzbos = 0;
                return;
            }
    ...
    public final void zzJ(long j) {
        zzcic zzzh = super.zzwx().zzzh();
        for (String next : this.zzboq.keySet()) {
            zza(next, j - this.zzboq.get(next).longValue(), (AppMeasurement.zzb) zzzh);
        }
        if (!this.zzboq.isEmpty()) {
            zza(j - this.zzbos, (AppMeasurement.zzb) zzzh);
        }

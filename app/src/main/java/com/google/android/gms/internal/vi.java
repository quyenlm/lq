...
public final class vi {
    ...
    public static vi zza(wp wpVar, xf xfVar) {
        return new vi(vl.CHILD_ADDED, xfVar, wpVar, (wp) null, (xf) null);
    }

    public static vi zza(wp wpVar, xf xfVar, xf xfVar2) {
        return new vi(vl.CHILD_CHANGED, xfVar, wpVar, (wp) null, xfVar2);
    }
    ...
    public static vi zza(xf xfVar) {
        return new vi(vl.VALUE, xfVar, (wp) null, (wp) null, (xf) null);
    }

    public static vi zzb(wp wpVar, xf xfVar) {
        return new vi(vl.CHILD_REMOVED, xfVar, wpVar, (wp) null, (xf) null);
    }

    public static vi zzc(wp wpVar, xf xfVar) {
        return new vi(vl.CHILD_MOVED, xfVar, wpVar, (wp) null, (xf) null);
    }

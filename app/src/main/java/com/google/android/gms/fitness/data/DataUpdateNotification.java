...
public class DataUpdateNotification extends zza {
    ...
    public boolean equals(Object obj) {
        if (obj != this) {
            ...
            if (!(this.zzaUa == dataUpdateNotification.zzaUa && this.zzaUb == dataUpdateNotification.zzaUb && this.zzaUc == dataUpdateNotification.zzaUc && zzbe.equal(this.zzaUd, dataUpdateNotification.zzaUd) && zzbe.equal(this.zzaUe, dataUpdateNotification.zzaUe))) {
                return false;
            }
        }
        return true;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 4, (Parcelable) getDataSource(), i, false);
        zzd.zza(parcel, 5, (Parcelable) getDataType(), i, false);

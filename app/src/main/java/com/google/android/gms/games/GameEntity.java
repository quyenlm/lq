...
public final class GameEntity extends GamesDowngradeableSafeParcel implements Game {
    ...
    static boolean zza(Game game, Object obj) {
        ...
        return zzbe.equal(Boolean.valueOf(game2.isTurnBasedMultiplayerEnabled()), Boolean.valueOf(game.isTurnBasedMultiplayerEnabled() && zzbe.equal(Boolean.valueOf(game2.isMuted()), Boolean.valueOf(game.isMuted())) && zzbe.equal(Boolean.valueOf(game2.zzue()), Boolean.valueOf(game.zzue())))) && zzbe.equal(Boolean.valueOf(game2.areSnapshotsEnabled()), Boolean.valueOf(game.areSnapshotsEnabled())) && zzbe.equal(game2.getThemeColor(), game.getThemeColor()) && zzbe.equal(Boolean.valueOf(game2.hasGamepadSupport()), Boolean.valueOf(game.hasGamepadSupport()));
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 7, (Parcelable) getIconImageUri(), i, false);
        zzd.zza(parcel, 8, (Parcelable) getHiResImageUri(), i, false);
        zzd.zza(parcel, 9, (Parcelable) getFeaturedImageUri(), i, false);

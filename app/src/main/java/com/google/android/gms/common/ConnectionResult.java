...
public final class ConnectionResult extends zza {
    ...
    static String getStatusString(int i) {
        switch (i) {
            ...
            default:
                return new StringBuilder(31).append("UNKNOWN_ERROR_CODE(").append(i).append(h.b).toString();
        }
    }
    ...
    public final String toString() {
        return zzbe.zzt(this).zzg("statusCode", getStatusString(this.zzaxu)).zzg(HttpRequestParams.RESOLUTION, this.mPendingIntent).zzg("message", this.zzazY).toString();
    }

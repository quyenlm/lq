...
public final class ly {
    ...
    public final FirebaseUser zzFa() {
        String string = this.zzBT.getString("com.google.firebase.auth.FIREBASE_USER", (String) null);
        if (TextUtils.isEmpty(string)) {
            return null;
        }
        try {
    ...
    public final kx zzh(@NonNull FirebaseUser firebaseUser) {
        zzbo.zzu(firebaseUser);
        String string = this.zzBT.getString(String.format("com.google.firebase.auth.GET_TOKEN_RESPONSE.%s", new Object[]{firebaseUser.getUid()}), (String) null);
        if (string != null) {

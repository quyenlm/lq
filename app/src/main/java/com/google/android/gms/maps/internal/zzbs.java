...
public final class zzbs extends zzed implements IStreetViewPanoramaDelegate {
    ...
    public final void setOnStreetViewPanoramaCameraChangeListener(zzbf zzbf) throws RemoteException {
        Parcel zzZ = zzZ();
        zzef.zza(zzZ, (IInterface) zzbf);
        zzb(16, zzZ);
    }

    public final void setOnStreetViewPanoramaChangeListener(zzbh zzbh) throws RemoteException {
        Parcel zzZ = zzZ();
        zzef.zza(zzZ, (IInterface) zzbh);
        zzb(15, zzZ);
    }

    public final void setOnStreetViewPanoramaClickListener(zzbj zzbj) throws RemoteException {
        Parcel zzZ = zzZ();
        zzef.zza(zzZ, (IInterface) zzbj);
        zzb(17, zzZ);
    }

    public final void setOnStreetViewPanoramaLongClickListener(zzbl zzbl) throws RemoteException {
        Parcel zzZ = zzZ();
        zzef.zza(zzZ, (IInterface) zzbl);
        zzb(20, zzZ);
    }

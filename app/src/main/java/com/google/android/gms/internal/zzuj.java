...
public final class zzuj {
    ...
    public static void zza(Context context, String str, zzaff zzaff, String str2, boolean z, List<String> list) {
        if (list != null && !list.isEmpty()) {
            String str3 = z ? "1" : "0";
            for (String zza : list) {
                String zza2 = zza(zza(zza(zza(zza(zza(zza(zza, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzaff.zzXN.zzMf), "@gw_sdkver@", str), "@gw_sessid@", zzbs.zzbD().getSessionId()), "@gw_seqnum@", zzaff.zzSC), "@gw_adnetstatus@", zzaff.zzXO);
                if (zzaff.zzMG != null) {
                    zza2 = zza(zza(zza2, "@gw_adnetid@", zzaff.zzMG.zzLI), "@gw_allocid@", zzaff.zzMG.zzLK);
                }
                String zzb = zzaez.zzb(zza2, context);
                zzbs.zzbz();
                zzagz.zzd(context, str, zzb);
            }
        }
    }

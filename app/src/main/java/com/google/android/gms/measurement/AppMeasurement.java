...
public class AppMeasurement {
    ...
    public static final class Event extends FirebaseAnalytics.Event {
        ...
        public static final String[] zzbof = {"app_clear_data", "app_exception", "app_remove", "app_upgrade", "app_install", "app_update", "firebase_campaign", "error", "first_open", "first_visit", "in_app_purchase", "notification_dismiss", "notification_foreground", "notification_open", "notification_receive", "os_update", "session_start", "user_engagement", "ad_exposure", "adunit_exposure", "ad_query", "ad_activeview", "ad_impression", "ad_click", "screen_view", "firebase_extra_parameter"};
        public static final String[] zzbog = {"_cd", APP_EXCEPTION, "_ui", "_ug", "_in", "_au", "_cmp", "_err", "_f", "_v", "_iap", "_nd", "_nf", "_no", "_nr", "_ou", "_s", "_e", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", "_vs", "_ep"};
    ...
    public static final class Param extends FirebaseAnalytics.Param {
        ...
        public static final String[] zzboh = {"firebase_conversion", "engagement_time_msec", "exposure_time", "ad_event_id", "ad_unit_id", "firebase_error", "firebase_error_value", "firebase_error_length", "firebase_event_origin", "firebase_screen", "firebase_screen_class", "firebase_screen_id", "firebase_previous_screen", "firebase_previous_class", "firebase_previous_id", "message_device_time", "message_id", "message_name", "message_time", "previous_app_version", "previous_os_version", "topic", "update_with_analytics", "previous_first_open_count", "system_app", "system_app_update", "previous_install_count", "firebase_event_id", "firebase_extra_params_ct", "firebase_group_name", "firebase_list_length", "firebase_index", "firebase_event_name"};
        public static final String[] zzboi = {"_c", "_et", "_xt", "_aeid", "_ai", "_err", "_ev", "_el", "_o", "_sn", "_sc", "_si", "_pn", "_pc", "_pi", "_ndt", "_nmid", "_nmn", "_nmt", "_pv", "_po", "_nt", "_uwa", "_pfo", "_sys", "_sysu", "_pin", "_eid", "_epc", "_gn", "_ll", "_i", "_en"};
    ...
    public static final class UserProperty extends FirebaseAnalytics.UserProperty {
        ...
        public static final String[] zzbom = {"firebase_last_notification", "first_open_time", "first_visit_time", "last_deep_link_referrer", "user_id", "first_open_after_install"};
        public static final String[] zzbon = {FIREBASE_LAST_NOTIFICATION, "_fot", "_fvt", "_ldl", "_id", "_fi"};
    ...
    public Map<String, Object> getUserProperties(boolean z) {
        ...
        ArrayMap arrayMap = new ArrayMap(zzao.size());
        for (zzcji next : zzao) {
    ...
    public final void logEvent(@Size(max = 40, min = 1) @NonNull String str, Bundle bundle) {
        ...
        zzcem.zzxE();
        if ("_iap".equals(str) || (zzep = this.zzboe.zzwB().zzep(str)) == 0) {
            this.zzboe.zzwt().zza(VKAttachments.TYPE_APP, str, bundle, true);
            return;
        }
        this.zzboe.zzwB();
    ...
    public void registerOnScreenChangeCallback(@NonNull zza zza2) {
        this.zzboe.zzwx().registerOnScreenChangeCallback(zza2);
    }
    ...
    public final void setUserProperty(@Size(max = 24, min = 1) @NonNull String str, @Nullable @Size(max = 36) String str2) {
        ...
        setUserPropertyInternal(VKAttachments.TYPE_APP, str, str2);
    }
    ...
    public void unregisterOnScreenChangeCallback(@NonNull zza zza2) {
        this.zzboe.zzwx().unregisterOnScreenChangeCallback(zza2);
    }
}

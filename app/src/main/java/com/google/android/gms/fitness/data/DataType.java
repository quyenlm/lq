...
public final class DataType extends com.google.android.gms.common.internal.safeparcel.zza implements ReflectedParcelable {
    ...
    public static final DataType zzaTN = new DataType("com.google.accelerometer", Field.zza.zzaUC, Field.zza.zzaUD, Field.zza.zzaUE);
    ...
    public static final class zza {
        public static final DataType zzaTW = new DataType("com.google.internal.session.debug", Field.zza.zzaUF);
        public static final DataType zzaTX = new DataType("com.google.internal.session.v2", Field.zza.zzaUG);
    }

    static {
        com.google.android.gms.common.util.zza zza2 = new com.google.android.gms.common.util.zza();
        AGGREGATE_INPUT_TYPES = zza2;
        zza2.add(TYPE_ACTIVITY_SEGMENT);
    ...
    public static List<DataType> getAggregatesForInput(DataType dataType) {
        List list = zza.zzaTi.get(dataType);
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!(this.name.equals(dataType.name) && this.zzaTV.equals(dataType.zzaTV))) {
                return false;
            }
        }
        return true;

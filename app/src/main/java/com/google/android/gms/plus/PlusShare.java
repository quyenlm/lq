...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            ...
            zzbo.zzb(uri != null && !TextUtils.isEmpty(uri.toString()), (Object) "Must provide a call to action URL");
        ...
        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.zzbAz != null && this.zzbAz.size() > 1;
            ...
            zzbo.zza(!z2 || !booleanExtra, (Object) "Call-to-action buttons are only available for URLs.");
            zzbo.zza(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), (Object) "The content URL is required for interactive posts.");
            ...
            if (!z2 && equals) {
                ...
                if (this.zzbAz == null || this.zzbAz.isEmpty()) {
                    ...
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.zzbAz.get(0));
                }
                this.zzbAz = null;
            }
            if (z2 && !equals) {
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            ...
            zzbo.zzb(!TextUtils.isEmpty(str), (Object) "The deepLinkId parameter is required.");
            Bundle bundle = new Bundle();
    ...
    public static Person createPerson(String str, String str2) {
        if (TextUtils.isEmpty(str)) {
            ...
            return new zzcri(str2, str, (zzcri.zzc) null, 0, (String) null);
        } else {

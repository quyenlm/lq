...
public class AddPlaceRequest extends zza {
    ...
    public AddPlaceRequest(String str, LatLng latLng, String str2, List<Integer> list, Uri uri) {
        this(str, latLng, str2, list, (String) null, (Uri) zzbo.zzu(uri));
    }

    public AddPlaceRequest(String str, LatLng latLng, String str2, List<Integer> list, String str3) {
        this(str, latLng, str2, list, zzbo.zzcF(str3), (Uri) null);
    }
    ...
    public AddPlaceRequest(String str, LatLng latLng, String str2, List<Integer> list, String str3, Uri uri) {
        ...
        zzbo.zzb(!this.zzbjj.isEmpty(), (Object) "At least one place type should be provided.");
        zzbo.zzb((!TextUtils.isEmpty(str3) || uri != null) ? true : z, (Object) "One of phone number or URI should be provided.");
        this.zzbjk = str3;
        this.zzbjl = uri;
    }

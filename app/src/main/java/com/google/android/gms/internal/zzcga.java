...
public final class zzcga {
    ...
    private zzcga(zzcfw zzcfw, String str, long j) {
        this.zzbrF = zzcfw;
        zzbo.zzcF(str);
        zzbo.zzaf(j > 0);
    ...
    public final void zzf(String str, long j) {
        ...
        boolean z = (this.zzbrF.zzwB().zzzt().nextLong() & FileTracerConfig.FOREVER) < FileTracerConfig.FOREVER / (j2 + 1);
        SharedPreferences.Editor edit2 = this.zzbrF.zzaix.edit();
        if (z) {
    ...
    public final Pair<String, Long> zzmb() {
        ...
        String string = this.zzbrF.zzyF().getString(this.zzbrJ, (String) null);

...
public final class zzaic {
    ...
    public final String toString() {
        return zzbe.zzt(this).zzg("name", this.name).zzg("minBound", Double.valueOf(this.zzZY)).zzg("maxBound", Double.valueOf(this.zzZX)).zzg("percent", Double.valueOf(this.zzZZ)).zzg(VKApiConst.COUNT, Integer.valueOf(this.count)).toString();
    }
}

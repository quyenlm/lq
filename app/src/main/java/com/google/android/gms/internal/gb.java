...
public abstract class gb extends zzee implements ga {
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            case 1:
                zza(IObjectWrapper.zza.zzM(parcel.readStrongBinder()), (WalletFragmentOptions) zzef.zza(parcel, WalletFragmentOptions.CREATOR), (Bundle) zzef.zza(parcel, Bundle.CREATOR));
            ...
            case 2:
                ...
                break;
            case 3:
                IObjectWrapper onCreateView = onCreateView(IObjectWrapper.zza.zzM(parcel.readStrongBinder()), IObjectWrapper.zza.zzM(parcel.readStrongBinder()), (Bundle) zzef.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                zzef.zza(parcel2, (IInterface) onCreateView);
                break;
            case 4:
                onStart();
                parcel2.writeNoException();

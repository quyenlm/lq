...
public class Payload {
    ...
    public static class File {
        ...
        public static File zza(java.io.File file, long j) throws FileNotFoundException {
            return new File((java.io.File) zzbo.zzb(file, (Object) "Cannot create Payload.File from null java.io.File."), ParcelFileDescriptor.open(file, DriveFile.MODE_READ_ONLY), j);
        }

        public static File zzb(ParcelFileDescriptor parcelFileDescriptor) {
            return new File((java.io.File) null, (ParcelFileDescriptor) zzbo.zzb(parcelFileDescriptor, (Object) "Cannot create Payload.File from null ParcelFileDescriptor."), parcelFileDescriptor.getStatSize());
        }
    ...
    public static class Stream {
        ...
        public static Stream zzc(ParcelFileDescriptor parcelFileDescriptor) {
            zzbo.zzb(parcelFileDescriptor, (Object) "Cannot create Payload.Stream from null ParcelFileDescriptor.");
            return new Stream(parcelFileDescriptor, (InputStream) null);
        }

        public static Stream zzi(InputStream inputStream) {
            zzbo.zzb(inputStream, (Object) "Cannot create Payload.Stream from null InputStream.");
    ...
    public static Payload fromBytes(byte[] bArr) {
        zzbo.zzb(bArr, (Object) "Cannot create a Payload from null bytes.");

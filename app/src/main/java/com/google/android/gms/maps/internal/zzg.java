...
public final class zzg extends zzed implements IGoogleMapDelegate {
    ...
    public final IPolylineDelegate addPolyline(PolylineOptions polylineOptions) throws RemoteException {
        ...
        IPolylineDelegate zzah = IPolylineDelegate.zza.zzah(zza.readStrongBinder());
        zza.recycle();
        return zzah;
    }
    ...
    public final IProjectionDelegate getProjection() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzbp = queryLocalInterface instanceof IProjectionDelegate ? (IProjectionDelegate) queryLocalInterface : new zzbp(readStrongBinder);
        }
        zza.recycle();
        return zzbp;
    }
    ...
    public final IUiSettingsDelegate getUiSettings() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzbv = queryLocalInterface instanceof IUiSettingsDelegate ? (IUiSettingsDelegate) queryLocalInterface : new zzbv(readStrongBinder);
        }
        zza.recycle();
        return zzbv;
    }

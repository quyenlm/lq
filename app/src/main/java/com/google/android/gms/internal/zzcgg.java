...
public final class zzcgg extends zzchj {
    ...
    private final Thread.UncaughtExceptionHandler zzbsa = new zzcgi(this, "Thread death: Uncaught exception on worker thread");
    private final Thread.UncaughtExceptionHandler zzbsb = new zzcgi(this, "Thread death: Uncaught exception on network thread");
    /* access modifiers changed from: private */
    ...
    public final void zzj(Runnable runnable) throws IllegalStateException {
        zzkD();
        zzbo.zzu(runnable);
        zza((zzcgj<?>) new zzcgj(this, runnable, false, "Task exception on worker thread"));
    }

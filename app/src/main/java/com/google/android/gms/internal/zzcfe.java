    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        ...
        switch (i) {
            ...
            case 6:
                ...
                break;
            case 7:
                List<zzcji> zza = zza((zzceh) zzef.zza(parcel, zzceh.CREATOR), zzef.zza(parcel));
                parcel2.writeNoException();
            ...
            case 13:
                ...
                break;
            case 14:
                List<zzcji> zza3 = zza(parcel.readString(), parcel.readString(), zzef.zza(parcel), (zzceh) zzef.zza(parcel, zzceh.CREATOR));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza3);
                break;
            case 15:
                List<zzcji> zza4 = zza(parcel.readString(), parcel.readString(), parcel.readString(), zzef.zza(parcel));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza4);
                break;
            case 16:
                List<zzcek> zza5 = zza(parcel.readString(), parcel.readString(), (zzceh) zzef.zza(parcel, zzceh.CREATOR));
                parcel2.writeNoException();
                parcel2.writeTypedList(zza5);
                break;
            case 17:
                List<zzcek> zzk = zzk(parcel.readString(), parcel.readString(), parcel.readString());
                parcel2.writeNoException();

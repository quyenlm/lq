...
public final class RawDataPoint extends zza {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!(this.zzaUW == rawDataPoint.zzaUW && this.zzaUX == rawDataPoint.zzaUX && Arrays.equals(this.zzaUY, rawDataPoint.zzaUY) && this.zzaUZ == rawDataPoint.zzaUZ && this.zzaVa == rawDataPoint.zzaVa && this.zzaVb == rawDataPoint.zzaVb)) {
                return false;
            }
        }
        return true;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 3, (T[]) this.zzaUY, i, false);

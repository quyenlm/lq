...
public class GoogleSignInOptions extends zza implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    /* access modifiers changed from: private */
    public final ArrayList<Scope> zzalY;
    /* access modifiers changed from: private */
    ...
    public static final class Builder {
        ...
        private final String zzbR(String str) {
            zzbo.zzcF(str);
            zzbo.zzb(this.zzali == null || this.zzali.equals(str), (Object) "two different server client ids provided");
            return str;
        }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 3, (Parcelable) this.zzajb, i, false);

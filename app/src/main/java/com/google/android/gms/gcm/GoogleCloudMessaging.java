...
public class GoogleCloudMessaging {
    ...
    public static synchronized GoogleCloudMessaging getInstance(Context context) {
        ...
        synchronized (GoogleCloudMessaging.class) {
            if (zzbfO == null) {
                ...
                googleCloudMessaging2.zzqD = context.getApplicationContext();
            }
    ...
    private final Intent zza(Bundle bundle, boolean z) throws IOException {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                return this.zzbfS.poll(NotificationOptions.SKIP_STEP_THIRTY_SECONDS_IN_MS, TimeUnit.MILLISECONDS);
    ...
    private final synchronized String zza(boolean z, String... strArr) throws IOException {
        ...
        if (zzbd.contains(".gsf")) {
            ...
            stringExtra = InstanceID.getInstance(this.zzqD).getToken(zzc, INSTANCE_ID_SCOPE, bundle);
        } else {

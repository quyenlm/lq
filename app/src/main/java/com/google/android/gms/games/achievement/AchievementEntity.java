...
public final class AchievementEntity extends zzc implements Achievement {
    ...
    static String zza(Achievement achievement) {
        zzbg zzg = zzbe.zzt(achievement).zzg(JsonDocumentFields.POLICY_ID, achievement.getAchievementId()).zzg("Type", Integer.valueOf(achievement.getType())).zzg("Name", achievement.getName()).zzg("Description", achievement.getDescription()).zzg("Player", achievement.getPlayer()).zzg("State", Integer.valueOf(achievement.getState()));
        if (achievement.getType() == 1) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof Achievement) {
            ...
            if (getType() == 1) {
                z2 = zzbe.equal(Integer.valueOf(achievement.getCurrentSteps()), Integer.valueOf(getCurrentSteps()));
                z = zzbe.equal(Integer.valueOf(achievement.getTotalSteps()), Integer.valueOf(getTotalSteps()));
            } else {
                z = true;
                z2 = true;
            }
            return zzbe.equal(achievement.getAchievementId(), getAchievementId()) && zzbe.equal(achievement.getName(), getName()) && zzbe.equal(Integer.valueOf(achievement.getType()), Integer.valueOf(getType())) && zzbe.equal(achievement.getDescription(), getDescription()) && zzbe.equal(Long.valueOf(achievement.getXpValue()), Long.valueOf(getXpValue())) && zzbe.equal(Integer.valueOf(achievement.getState()), Integer.valueOf(getState())) && zzbe.equal(Long.valueOf(achievement.getLastUpdatedTimestamp()), Long.valueOf(getLastUpdatedTimestamp())) && zzbe.equal(achievement.getPlayer(), getPlayer()) && z2 && z;
        }
    }

...
public final class zzcgf extends zzchj {
    ...
    private final void zza(String str, zzcjt zzcjt) {
        ...
        if (!(zzcjt == null || zzcjt.zzbvo == null)) {
            for (zzcjs zzcjs : zzcjt.zzbvo) {
                if (zzcjs != null) {
                    String zzdF = AppMeasurement.Event.zzdF(zzcjs.name);
                    if (zzdF != null) {
                        zzcjs.name = zzdF;
                    }
    ...
    private final void zzeg(String str) {
        ...
        if (this.zzbrT.get(str) == null) {
            ...
            if (zzdS == null) {
                this.zzbrQ.put(str, (Object) null);
                this.zzbrR.put(str, (Object) null);
                this.zzbrS.put(str, (Object) null);
                this.zzbrT.put(str, (Object) null);
                this.zzbrU.put(str, (Object) null);
                return;
            }
    ...
    public final boolean zzb(String str, byte[] bArr, String str2) {
        ...
        for (zzcjm zzcjm : zzcjmArr) {
            for (zzcjn zzcjn : zzcjm.zzbuK) {
                String zzdF = AppMeasurement.Event.zzdF(zzcjn.zzbuN);
                if (zzdF != null) {
                    zzcjn.zzbuN = zzdF;
                }
                for (zzcjo zzcjo : zzcjn.zzbuO) {
                    String zzdF2 = AppMeasurement.Param.zzdF(zzcjo.zzbuV);
                    if (zzdF2 != null) {
                        zzcjo.zzbuV = zzdF2;
                    }
                }
            ...
            for (zzcjq zzcjq : zzcjm.zzbuJ) {
                String zzdF3 = AppMeasurement.UserProperty.zzdF(zzcjq.zzbvc);
                if (zzdF3 != null) {
                    zzcjq.zzbvc = zzdF3;
                }
            }

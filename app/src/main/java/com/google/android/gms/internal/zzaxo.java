...
public final class zzaxo implements PlayerInfo {
    ...
    public final boolean equals(Object obj) {
        ...
        return this.zzaxE == playerInfo.isControllable() && this.zzaqz == playerInfo.getPlayerState() && zzaye.zza(this.zzaxn, playerInfo.getPlayerId()) && zzo.zzc(this.zzaxD, playerInfo.getPlayerData());
    }

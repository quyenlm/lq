...
public final class TurnBasedMatchEntity extends zzc implements TurnBasedMatch {
    ...
    public TurnBasedMatchEntity(TurnBasedMatch turnBasedMatch) {
        ...
        if (previousMatchData == null) {
            ...
            this.zzbea = new byte[previousMatchData.length];
            System.arraycopy(previousMatchData, 0, this.zzbea, 0, previousMatchData.length);
        }
        ArrayList<Participant> participants = turnBasedMatch.getParticipants();
        int size = participants.size();
        this.zzbdt = new ArrayList<>(size);
        for (int i = 0; i < size; i++) {
            this.zzbdt.add((ParticipantEntity) participants.get(i).freeze());
        }
    }
    ...
    public final int getAvailableAutoMatchSlots() {
        ...
        return this.zzbdL.getInt(Multiplayer.EXTRA_MAX_AUTOMATCH_PLAYERS);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 1, (Parcelable) getGame(), i, false);

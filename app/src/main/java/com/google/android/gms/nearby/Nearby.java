...
public final class Nearby {
    public static final Api<Api.ApiOptions.NoOptions> CONNECTIONS_API = new Api<>("Nearby.CONNECTIONS_API", zzclm.zzajS, zzclm.zzajR);
    ...
    private static Api<Api.ApiOptions.NoOptions> zzbwj = new Api<>("Nearby.BOOTSTRAP_API", zzcke.zzajS, zzcke.zzajR);

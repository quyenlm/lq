...
public class AdBreakInfo extends zza {
    ...
    public static class Builder {
        ...
        public AdBreakInfo build() {
            return new AdBreakInfo(this.zzaoE, (String) null, 0, false, (String[]) null);
        }
    }
    ...
    static AdBreakInfo zzi(JSONObject jSONObject) {
        ...
        if (!jSONObject.has("id") || !jSONObject.has(VKApiConst.POSITION)) {
            return null;
        }
        try {
            String string = jSONObject.getString("id");
            long j = (long) (((double) jSONObject.getLong(VKApiConst.POSITION)) * 1000.0d);

...
final class ju extends kj<Void, ll> {
    ...
    public ju(UserProfileChangeRequest userProfileChangeRequest) {
        super(2);
        this.zzbWD = (UserProfileChangeRequest) zzbo.zzb(userProfileChangeRequest, (Object) "request cannot be null");
    }

    public final void dispatch() throws RemoteException {
        this.zzbWM.zza(this.zzbWL.zzEH(), this.zzbWD, (ka) this.zzbWK);
    }

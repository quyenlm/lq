...
public abstract class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener roomUpdateListener) {
            ...
            this.zzbdG = (RoomUpdateListener) zzbo.zzb(roomUpdateListener, (Object) "Must provide a RoomUpdateListener");
        }
        ...
        public final Builder setVariant(int i) {
            zzbo.zzb(i == -1 || i > 0, (Object) "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.zzbdu = i;
            return this;
        }
    }

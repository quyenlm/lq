...
public class StreetViewPanoramaLocation extends zza {
    ...
    public String toString() {
        return zzbe.zzt(this).zzg("panoId", this.panoId).zzg(VKApiConst.POSITION, this.position.toString()).toString();
    }

    public void writeToParcel(Parcel parcel, int i) {
        int zze = zzd.zze(parcel);
        zzd.zza(parcel, 2, (T[]) this.links, i, false);
        zzd.zza(parcel, 3, (Parcelable) this.position, i, false);

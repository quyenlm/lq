...
public final class zzbgj<I, O> extends zza {
    ...
    public zzbgk<I, O> zzaIQ;
    private final int zzaku;

    zzbgj(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, zzbgc zzbgc) {
        this.zzaku = i;
        this.zzaIH = i2;
        this.zzaII = z;
        this.zzaIJ = i3;
        ...
        if (zzbgc == null) {
            ...
            this.zzaIQ = zzbgc.zzrK();
        }
    }

    private zzbgj(int i, boolean z, int i2, boolean z2, String str, int i3, Class<? extends zzbgi> cls, zzbgk<I, O> zzbgk) {
        this.zzaku = 1;
        this.zzaIH = i;
        this.zzaII = z;
        this.zzaIJ = i2;
    ...
    public static zzbgj zza(String str, int i, zzbgk<?, ?> zzbgk, boolean z) {
        return new zzbgj(7, false, 0, false, str, i, (Class<? extends zzbgi>) null, zzbgk);
    }

    public static <T extends zzbgi> zzbgj<T, T> zza(String str, int i, Class<T> cls) {
        return new zzbgj<>(11, false, 11, false, str, i, cls, (zzbgk) null);
    }

    public static <T extends zzbgi> zzbgj<ArrayList<T>, ArrayList<T>> zzb(String str, int i, Class<T> cls) {
        return new zzbgj<>(11, true, 11, true, str, i, cls, (zzbgk) null);
    }

    public static zzbgj<Integer, Integer> zzj(String str, int i) {
        return new zzbgj<>(0, false, 0, false, str, i, (Class<? extends zzbgi>) null, (zzbgk) null);
    }

    public static zzbgj<Boolean, Boolean> zzk(String str, int i) {
        return new zzbgj<>(6, false, 6, false, str, i, (Class<? extends zzbgi>) null, (zzbgk) null);
    }

    public static zzbgj<String, String> zzl(String str, int i) {
        return new zzbgj<>(7, false, 7, false, str, i, (Class<? extends zzbgi>) null, (zzbgk) null);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 9, (Parcelable) this.zzaIQ == null ? null : zzbgc.zza(this.zzaIQ), i, false);
        zzd.zzI(parcel, zze);
    }

...
public final class CameraPosition extends zza implements ReflectedParcelable {
    ...
    public CameraPosition(LatLng latLng, float f, float f2, float f3) {
        zzbo.zzb(latLng, (Object) "null camera target");
        zzbo.zzb(0.0f <= f2 && f2 <= 90.0f, "Tilt needs to be between 0 and 90 inclusive: %s", Float.valueOf(f2));
        this.target = latLng;
        this.zoom = f;
        this.tilt = f2 + 0.0f;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 2, (Parcelable) this.target, i, false);

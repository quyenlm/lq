...
public final class zzctu extends zzz<zzcts> implements zzctk {
    ...
    public zzctu(Context context, Looper looper, boolean z, zzq zzq, Bundle bundle, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public zzctu(Context context, Looper looper, boolean z, zzq zzq, zzctl zzctl, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public final void zza(zzctq zzctq) {
        zzbo.zzb(zzctq, (Object) "Expecting a valid ISignInCallbacks");
        try {

...
public class Fitness {
    ...
    public static final Api<Api.ApiOptions.NoOptions> BLE_API = zzbup.API;
    public static final BleApi BleApi = (Build.VERSION.SDK_INT >= 18 ? new zzbxk() : new zzbzj());
    public static final Api<Api.ApiOptions.NoOptions> CONFIG_API = zzbut.API;
    public static final ConfigApi ConfigApi = new zzbxs();
    public static final String EXTRA_END_TIME = "vnd.google.fitness.end_time";
    public static final String EXTRA_START_TIME = "vnd.google.fitness.start_time";
    public static final Api<Api.ApiOptions.NoOptions> GOALS_API = zzbux.API;
    public static final GoalsApi GoalsApi = new zzbxx();
    public static final Api<Api.ApiOptions.NoOptions> HISTORY_API = zzbva.API;
    public static final HistoryApi HistoryApi = new zzbya();
    public static final Api<Api.ApiOptions.NoOptions> RECORDING_API = zzbvg.API;
    ...
    public static final Api<Api.ApiOptions.NoOptions> SENSORS_API = zzbvk.API;
    public static final Api<Api.ApiOptions.NoOptions> SESSIONS_API = zzbvo.API;
    public static final SensorsApi SensorsApi = new zzbys();
    public static final SessionsApi SessionsApi = new zzbyz();
    private static Api<Api.ApiOptions.NoOptions> zzaMc = zzbve.API;

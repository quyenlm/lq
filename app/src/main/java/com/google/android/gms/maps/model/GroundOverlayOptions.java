...
public final class GroundOverlayOptions extends zza {
    ...
    public final GroundOverlayOptions image(@NonNull BitmapDescriptor bitmapDescriptor) {
        zzbo.zzb(bitmapDescriptor, (Object) "imageDescriptor must not be null");
    ...
    public final GroundOverlayOptions positionFromBounds(LatLngBounds latLngBounds) {
        ...
        zzbo.zza(z, (Object) new StringBuilder(String.valueOf(valueOf).length() + 46).append("Position has already been set using position: ").append(valueOf).toString());
        this.zzblq = latLngBounds;
        return this;
    }

    public final GroundOverlayOptions transparency(float f) {
        zzbo.zzb(f >= 0.0f && f <= 1.0f, (Object) "Transparency must be in the range [0..1]");
        this.zzbnt = f;
        return this;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 3, (Parcelable) getLocation(), i, false);
        zzd.zza(parcel, 4, getWidth());
        zzd.zza(parcel, 5, getHeight());
        zzd.zza(parcel, 6, (Parcelable) getBounds(), i, false);

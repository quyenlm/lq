...
public final class pq {
    ...
    public final void cancel() {
        if (this.zzccq != null) {
            this.zzbZE.zzb("Cancelling existing retry attempt", (Throwable) null, new Object[0]);
            this.zzccq.cancel(false);
            this.zzccq = null;
        } else {
            this.zzbZE.zzb("No existing retry attempt to cancel", (Throwable) null, new Object[0]);
        }
        this.zzccr = 0;
    }
    ...
    public final void zzp(Runnable runnable) {
        ...
        if (this.zzccq != null) {
            this.zzbZE.zzb("Cancelling previous scheduled retry", (Throwable) null, new Object[0]);
            this.zzccq.cancel(false);
            this.zzccq = null;
        }
        if (!this.zzccs) {
            if (this.zzccr == 0) {
                this.zzccr = this.zzccm;
            } else {
                this.zzccr = Math.min((long) (((double) this.zzccr) * this.zzccp), this.zzccn);
            }
            j = (long) (((1.0d - this.zzcco) * ((double) this.zzccr)) + (this.zzcco * ((double) this.zzccr) * this.random.nextDouble()));
        }
        this.zzccs = false;
        this.zzbZE.zzb("Scheduling retry in %dms", (Throwable) null, Long.valueOf(j));

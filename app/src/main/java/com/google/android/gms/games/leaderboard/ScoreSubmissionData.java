...
public final class ScoreSubmissionData {
    private static final String[] zzbcJ = {"leaderboardId", "playerId", "timeSpan", "hasResult", "rawScore", "formattedScore", "newBest", "scoreTag"};
    ...
    public final Result getScoreResult(int i) {
        return this.zzbdq.get(Integer.valueOf(i));
    }
    ...
    public final String toString() {
        ...
        while (true) {
            ...
            Result result = this.zzbdq.get(Integer.valueOf(i2));
            zzg.zzg("TimesSpan", zzcai.zzbc(i2));
            zzg.zzg("Result", result == null ? Constants.NULL_VERSION_ID : result.toString());
            i = i2 + 1;
        }
    }
}

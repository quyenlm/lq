...
public final class zzcjg extends zzchj {
    private final AlarmManager zzahd = ((AlarmManager) super.getContext().getSystemService(NotificationCompat.CATEGORY_ALARM));
    private final zzcer zzbuv;
    private Integer zzbuw;

    protected zzcjg(zzcgl zzcgl) {
        super(zzcgl);
    ...
    private final void zzzq() {
        ...
        ((JobScheduler) super.getContext().getSystemService("jobscheduler")).cancel(getJobId());
    }
    ...
    public final void zzs(long j) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            JobInfo.Builder builder = new JobInfo.Builder(getJobId(), new ComponentName(super.getContext(), "com.google.android.gms.measurement.AppMeasurementJobService"));
            ...
            ((JobScheduler) super.getContext().getSystemService("jobscheduler")).schedule(build);
            return;
        }

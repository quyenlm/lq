...
public final class Plus {
    ...
    public static final Api.zzf<zzh> zzajR = new Api.zzf<>();
    private static Api.zza<zzh, PlusOptions> zzajS = new zzc();
    @Deprecated
    ...
    public static final class PlusOptions implements Api.ApiOptions.Optional {
        ...
        public static final class Builder {
            ...
            public final Builder addActivityTypes(String... strArr) {
                zzbo.zzb(strArr, (Object) "activityTypes may not be null.");
    ...
    public static zzh zzc(GoogleApiClient googleApiClient, boolean z) {
        ...
        zzbo.zza(googleApiClient.zza((Api<?>) API), (Object) "GoogleApiClient is not configured to use the Plus.API Api. Pass this into GoogleApiClient.Builder#addApi() to use this feature.");
        boolean hasConnectedApi = googleApiClient.hasConnectedApi(API);
        if (z && !hasConnectedApi) {
            throw new IllegalStateException("GoogleApiClient has an optional Plus.API and is not connected to Plus. Use GoogleApiClient.hasConnectedApi(Plus.API) to guard this call.");
        } else if (hasConnectedApi) {
            return (zzh) googleApiClient.zza(zzajR);
        } else {
            return null;
        }
    }

...
public class Bucket extends zza implements ReflectedParcelable {
    ...
    public String toString() {
        return zzbe.zzt(this).zzg("startTime", Long.valueOf(this.zzagZ)).zzg(HttpRequestParams.NOTICE_END_TIME, Long.valueOf(this.zzaTo)).zzg("activity", Integer.valueOf(this.zzaTp)).zzg("dataSets", this.zzaTq).zzg("bucketType", zzaS(this.zzaTr)).zzg("serverHasMoreData", Boolean.valueOf(this.zzaTs)).toString();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 3, (Parcelable) getSession(), i, false);

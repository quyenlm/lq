...
public final class QuestEntity extends zzc implements Quest {
    ...
    public QuestEntity(Quest quest) {
        ...
        List<Milestone> zzvt = quest.zzvt();
        int size = zzvt.size();
        this.zzber = new ArrayList<>(size);
        for (int i = 0; i < size; i++) {
            this.zzber.add((MilestoneEntity) zzvt.get(i).freeze());
        }
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 4, (Parcelable) getBannerImageUri(), i, false);
        ...
        zzd.zza(parcel, 9, (Parcelable) getIconImageUri(), i, false);

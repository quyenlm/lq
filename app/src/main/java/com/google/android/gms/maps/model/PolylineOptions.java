...
public final class PolylineOptions extends zza {
    ...
    public final PolylineOptions endCap(@NonNull Cap cap) {
        this.zzbnT = (Cap) zzbo.zzb(cap, (Object) "endCap must not be null");
        return this;
    }
    ...
    public final PolylineOptions startCap(@NonNull Cap cap) {
        this.zzbnS = (Cap) zzbo.zzb(cap, (Object) "startCap must not be null");
        return this;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 9, (Parcelable) getStartCap(), i, false);
        zzd.zza(parcel, 10, (Parcelable) getEndCap(), i, false);

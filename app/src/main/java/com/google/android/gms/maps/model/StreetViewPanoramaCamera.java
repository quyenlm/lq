...
public class StreetViewPanoramaCamera extends zza implements ReflectedParcelable {
    ...
    public StreetViewPanoramaCamera(float f, float f2, float f3) {
        zzbo.zzb(-90.0f <= f2 && f2 <= 90.0f, (Object) new StringBuilder(62).append("Tilt needs to be between -90 and 90 inclusive: ").append(f2).toString());
        ...
        this.zzbnW = new StreetViewPanoramaOrientation.Builder().tilt(f2).bearing(f3).build();
    }

...
public final class RawBucket extends zza {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (!(this.zzagZ == rawBucket.zzagZ && this.zzaTo == rawBucket.zzaTo && this.zzaUV == rawBucket.zzaUV && zzbe.equal(this.zzaTq, rawBucket.zzaTq) && this.zzaTr == rawBucket.zzaTr && this.zzaTs == rawBucket.zzaTs)) {
                return false;
            }
        }
        return true;
    ...
    public final String toString() {
        return zzbe.zzt(this).zzg("startTime", Long.valueOf(this.zzagZ)).zzg(HttpRequestParams.NOTICE_END_TIME, Long.valueOf(this.zzaTo)).zzg("activity", Integer.valueOf(this.zzaUV)).zzg("dataSets", this.zzaTq).zzg("bucketType", Integer.valueOf(this.zzaTr)).zzg("serverHasMoreData", Boolean.valueOf(this.zzaTs)).toString();
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 3, (Parcelable) this.zzaTe, i, false);

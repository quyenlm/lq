...
final class zzyy implements Runnable {
    ...
    public final void run() {
        try {
            ...
            zzgz.zziw().zza(this.zzSb.zza((WeakReference<zzaka>) weakReference), this.zzSb.zzb(weakReference));
            this.zzSb.zzi(zzgz);
            zzgz.zziw().zza((zzakg) new zzyz(this, zzgz));
            zzgz.zziw().zza((zzakf) new zzza(this));
            zzgz.loadUrl((String) zzbs.zzbL().zzd(zzmo.zzFs));
        } catch (Exception e) {
            zzafr.zzc("Exception occurred while getting video view", e);
            this.zzSa.zzg(null);
        }
    }
}

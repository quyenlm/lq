...
final class zzap extends RemoteMediaPlayer.zzb {
    ...
    zzap(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, JSONObject jSONObject) {
    ...
    public final void zza(zzaxx zzaxx) {
        synchronized (this.zzaqV.mLock) {
            ...
            try {
                this.zzaqV.zzaqP.zza(this.zzarw, this.zzarh, this.zzarc);

...
public final class zzb implements LeaderboardVariant {
    ...
    static String zzb(LeaderboardVariant leaderboardVariant) {
        ...
        return zzg.zzg("Collection", str).zzg("RawPlayerScore", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getRawPlayerScore()) : APNUtil.ANP_NAME_NONE).zzg("DisplayPlayerScore", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerScore() : APNUtil.ANP_NAME_NONE).zzg("PlayerRank", leaderboardVariant.hasPlayerInfo() ? Long.valueOf(leaderboardVariant.getPlayerRank()) : APNUtil.ANP_NAME_NONE).zzg("DisplayPlayerRank", leaderboardVariant.hasPlayerInfo() ? leaderboardVariant.getDisplayPlayerRank() : APNUtil.ANP_NAME_NONE).zzg("NumScores", Long.valueOf(leaderboardVariant.getNumScores())).zzg("TopPageNextToken", leaderboardVariant.zzvo()).zzg("WindowPageNextToken", leaderboardVariant.zzvq()).zzg("WindowPagePrevToken", leaderboardVariant.zzvp()).toString();
    }

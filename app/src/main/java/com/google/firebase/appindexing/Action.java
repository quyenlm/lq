...
public interface Action {
    ...
    public static class Builder {
        ...
        public Action build() {
            ...
            return new zza(this.zzbVu, this.zzbVv, this.zzbVw, this.zzbVx, this.zzbVy == null ? new Metadata.Builder().zzEz() : this.zzbVy, this.zzbVz);
        }
    ...
    public interface Metadata {
        ...
        public static class Builder {
            ...
            public final zzb zzEz() {
                return new zzb(this.zzbVA, (String) null, (String) null, (byte[]) null, false);
            }
        }
    }
}

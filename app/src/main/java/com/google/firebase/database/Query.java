...
public class Query {
    ...
    private Query(qu quVar, qr qrVar, vq vqVar, boolean z) throws DatabaseException {
        ...
        this.zzbZj = vqVar;
        this.zzbZk = z;
        zd.zzb(!vqVar.zzIe() || !vqVar.zzIh() || !vqVar.zzIk() || vqVar.zzIl(), "Validation of queries failed.");
    }
    ...
    private static void zza(vq vqVar) {
        ...
        } else if (!vqVar.zzIm().equals(xr.zzJl())) {
        } else {
    ...
    public ChildEventListener addChildEventListener(ChildEventListener childEventListener) {
        zzb((qi) new px(this.zzbYY, childEventListener, zzFr()));
        return childEventListener;
    }

    public void addListenerForSingleValueEvent(ValueEventListener valueEventListener) {
        zzb((qi) new to(this.zzbYY, new zzp(this, valueEventListener), zzFr()));
    }

    public ValueEventListener addValueEventListener(ValueEventListener valueEventListener) {
        zzb((qi) new to(this.zzbYY, valueEventListener, zzFr()));
    ...
    public void removeEventListener(ChildEventListener childEventListener) {
        ...
        zza((qi) new px(this.zzbYY, childEventListener, zzFr()));
    }
    ...
    public void removeEventListener(ValueEventListener valueEventListener) {
        ...
        zza((qi) new to(this.zzbYY, valueEventListener, zzFr()));
    }

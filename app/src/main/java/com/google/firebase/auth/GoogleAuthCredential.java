...
public class GoogleAuthCredential extends AuthCredential {
    public static final Parcelable.Creator<GoogleAuthCredential> CREATOR = new zzn();
    ...
    public static lj zza(@NonNull GoogleAuthCredential googleAuthCredential) {
        ...
        return new lj(googleAuthCredential.zzaln, googleAuthCredential.zzbCx, googleAuthCredential.getProvider(), (String) null, (String) null);
    }

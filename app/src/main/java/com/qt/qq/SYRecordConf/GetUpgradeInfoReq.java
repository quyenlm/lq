...
public final class GetUpgradeInfoReq extends Message {
    ...
    public GetUpgradeInfoReq(ByteString user_id2, ByteString pkg_name2, ByteString os_version2, ByteString sdk_version2, ByteString plugin_version2, ByteString phone_type2, Integer source2, ByteString openid2, ByteString access_token2, Long qqappid2) {
    ...
    private GetUpgradeInfoReq(Builder builder) {
        this(builder.user_id, builder.pkg_name, builder.os_version, builder.sdk_version, builder.plugin_version, builder.phone_type, builder.source, builder.openid, builder.access_token, builder.qqappid);
        setBuilder(builder);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GetUpgradeInfoReq)) {
            return false;
        }
    ...
    public static final class Builder extends Message.Builder<GetUpgradeInfoReq> {
        ...
        public Builder(GetUpgradeInfoReq message) {
            super(message);
            if (message != null) {
        ...
        public GetUpgradeInfoReq build() {
            return new GetUpgradeInfoReq(this);
        }
    }
}

...
public class VKApiFriends extends VKApiBase {
    public VKRequest get(VKParameters params) {
        if (params.get("fields") != null) {
            return prepareRequest("get", params, (Class<? extends VKApiModel>) VKUsersArray.class);
        }
    ...
    public VKRequest getByPhones(VKParameters params) {
        return prepareRequest("getByPhones", params, (Class<? extends VKApiModel>) VKUsersArray.class);
    }

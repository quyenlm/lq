...
public class MeasurementEvent {
    ...
    static void sendBroadcastEvent(Context context, String name2, Intent intent, Map<String, String> extraLoggingData) {
        Bundle logData = new Bundle();
        if (intent != null) {
            Bundle applinkData = AppLinks.getAppLinkData(intent);
            if (applinkData != null) {
                logData = getApplinkLogData(context, name2, applinkData, intent);
            } else {
        ...
        new MeasurementEvent(context, name2, logData).sendBroadcast();
    }
    ...
    private void sendBroadcast() {
        ...
        try {
            ...
            Object localBroadcastManager = methodGetInstance.invoke((Object) null, new Object[]{this.appContext});
        ...
        for (String key : appLinkData.keySet()) {
            ...
            if (o instanceof Bundle) {
                for (String subKey : ((Bundle) o).keySet()) {
                    ...
                    logData.putString(key + Constants.URL_PATH_DELIMITER + subKey, logValue);
                }
            } else {

...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    private static final String[] TagSearchSpecial = {"address", "applet", "area", "article", "aside", "base", "basefont", "bgsound", "blockquote", "body", "br", "button", ShareConstants.FEED_CAPTION_PARAM, "center", "col", "colgroup", "command", "dd", "details", "dir", "div", "dl", "dt", "embed", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_HEADER, "hgroup", "hr", ContentType.SUBTYPE_HTML, "iframe", IMFriendInfoExViber.IMG, "input", "isindex", "li", "link", "listing", "marquee", "menu", "meta", "nav", "noembed", "noframes", "noscript", "object", "ol", "p", "param", "plaintext", "pre", "script", "section", "select", AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE, "summary", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "title", "tr", "ul", "wbr", "xmp"};
    private static final String[] TagSearchTableScope = {ContentType.SUBTYPE_HTML, "table"};
    private static final String[] TagsScriptStyle = {"script", AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE};
    public static final String[] TagsSearchInScope = {"applet", ShareConstants.FEED_CAPTION_PARAM, ContentType.SUBTYPE_HTML, "table", "td", "th", "marquee", "object"};
    ...
    public List<Node> parseFragment(String inputFragment, Element context, String baseUri, ParseErrorList errors) {
        ...
        if (context != null) {
            ...
            if (StringUtil.in(contextTag, "title", "textarea")) {
                ...
                if (StringUtil.in(contextTag, "iframe", "noembed", "noframes", AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE, "xmp")) {
            ...
            root = new Element(Tag.valueOf(ContentType.SUBTYPE_HTML), baseUri);
    ...
    public void maybeSetBaseUri(Element base) {
        if (!this.baseUriSetFromDoc) {
            String href = base.absUrl(ShareConstants.WEB_DIALOG_PARAM_HREF);
            if (href.length() != 0) {
                this.baseUri = href;
    ...
    public void insert(Token.Character characterToken) {
        ...
        if (tagName.equals("script") || tagName.equals(AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE)) {
    ...
    public void popStackToClose(String... elNames) {
        ...
        while (pos >= 0) {
            this.stack.remove(pos);
            if (!StringUtil.in(((Element) this.stack.get(pos)).nodeName(), elNames)) {
                pos--;
            } else {
                return;
            }
    ...
    private void clearStackToContext(String... nodeNames) {
        ...
        while (pos >= 0) {
            Element next = (Element) this.stack.get(pos);
            if (!StringUtil.in(next.nodeName(), nodeNames) && !next.nodeName().equals(ContentType.SUBTYPE_HTML)) {
                this.stack.remove(pos);
                pos--;
            } else {
                return;
    ...
    public void resetInsertionMode() {
        ...
        while (pos >= 0) {
            ...
            if ("select".equals(name)) {
                ...
                return;
            } else if (ShareConstants.FEED_CAPTION_PARAM.equals(name)) {
                ...
                return;
            } else if (ContentType.SUBTYPE_HTML.equals(name)) {
    ...
    public void clearFormattingElementsToLastMarker() {
        /*
            r2 = this;
        L_0x0000:
            java.util.ArrayList<org.jsoup.nodes.Element> r1 = r2.formattingElements
            boolean r1 = r1.isEmpty()
            if (r1 != 0) goto L_0x000e
            org.jsoup.nodes.Element r0 = r2.removeLastFormattingElement()

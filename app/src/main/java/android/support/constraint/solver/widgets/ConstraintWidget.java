...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + " " : "") + (this.mDebugName != null ? "id: " + this.mDebugName + " " : "") + h.a + this.mX + ", " + this.mY + ") - (" + this.mWidth + " x " + this.mHeight + h.b + " wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + h.b;
    }
    ...
    private void applyConstraints(LinearSystem system, boolean wrapContent, boolean dimensionFixed, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int endPosition, int dimension, int minDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension) {
        ...
        if (beginTarget == null && endTarget == null) {
            ...
            if (beginAnchor.getStrength() != endAnchor.getStrength()) {
                ...
                system.addConstraint(LinearSystem.createRowGreaterThan(system, begin, beginTarget, beginAnchorMargin, beginAnchor.getConnectionType() != ConstraintAnchor.ConnectionType.STRICT));
                system.addConstraint(LinearSystem.createRowLowerThan(system, end, endTarget, endAnchorMargin * -1, endAnchor.getConnectionType() != ConstraintAnchor.ConnectionType.STRICT));

...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - TimeUtils.MILLIS_IN_DAY, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(TimeUtils.MILLIS_IN_DAY + now, location.getLatitude(), location.getLongitude());
        ...
        if (todaySunrise == -1 || todaySunset == -1) {
            ...
            nextUpdate = nextUpdate2 + Constants.WATCHDOG_WAKE_TIMER;
        }

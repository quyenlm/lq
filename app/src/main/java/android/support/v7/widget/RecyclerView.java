...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x0281, code lost:
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            View view;
            if (position < 0 || position >= RecyclerView.this.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("Invalid item position " + position + h.a + position + "). Item count:" + RecyclerView.this.mState.getItemCount() + RecyclerView.this.exceptionLabel());
            }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + h.b);
            }

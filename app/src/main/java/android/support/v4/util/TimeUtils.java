...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        int pos5 = printField(formatStr, minutes, VKApiPhotoSize.M, pos4, pos4 != start, zeropad ? 2 : 0);
        int pos6 = printField(formatStr, seconds, VKApiPhotoSize.S, pos5, pos5 != start, zeropad ? 2 : 0);
        int pos7 = printField(formatStr, millis, VKApiPhotoSize.M, pos6, true, (!zeropad || pos6 == start) ? 0 : 3);
        formatStr[pos7] = VKApiPhotoSize.S;
        return pos7 + 1;
    }

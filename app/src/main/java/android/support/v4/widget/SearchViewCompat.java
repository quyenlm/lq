...
public final class SearchViewCompat {
    ...
    public static void setSearchableInfo(View searchView, ComponentName searchableComponent) {
        ...
        ((SearchView) searchView).setSearchableInfo(((SearchManager) searchView.getContext().getSystemService(FirebaseAnalytics.Event.SEARCH)).getSearchableInfo(searchableComponent));
    }

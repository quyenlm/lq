...
class NotificationCompatJellybean {
    ...
    public static android.support.v4.app.NotificationCompatBase.Action getAction(android.app.Notification r12, int r13, android.support.v4.app.NotificationCompatBase.Action.Factory r14, android.support.v4.app.RemoteInputCompatBase.RemoteInput.Factory r15) {
        /*
            ...
            monitor-enter(r11)
            java.lang.Object[] r8 = getActionObjectsLocked(r12)     // Catch:{ IllegalAccessException -> 0x003e }
            if (r8 == 0) goto L_0x0049
            r7 = r8[r13]     // Catch:{ IllegalAccessException -> 0x003e }
            r5 = 0
            android.os.Bundle r10 = getExtras(r12)     // Catch:{ IllegalAccessException -> 0x003e }
            if (r10 == 0) goto L_0x0020
            java.lang.String r0 = "android.support.actionExtras"
            android.util.SparseArray r6 = r10.getSparseParcelableArray(r0)     // Catch:{ IllegalAccessException -> 0x003e }
            if (r6 == 0) goto L_0x0020
            java.lang.Object r5 = r6.get(r13)     // Catch:{ IllegalAccessException -> 0x003e }
            android.os.Bundle r5 = (android.os.Bundle) r5     // Catch:{ IllegalAccessException -> 0x003e }
        L_0x0020:
            java.lang.reflect.Field r0 = sActionIconField     // Catch:{ IllegalAccessException -> 0x003e }
            int r2 = r0.getInt(r7)     // Catch:{ IllegalAccessException -> 0x003e }
            java.lang.reflect.Field r0 = sActionTitleField     // Catch:{ IllegalAccessException -> 0x003e }
            java.lang.Object r3 = r0.get(r7)     // Catch:{ IllegalAccessException -> 0x003e }
            java.lang.CharSequence r3 = (java.lang.CharSequence) r3     // Catch:{ IllegalAccessException -> 0x003e }
            java.lang.reflect.Field r0 = sActionIntentField     // Catch:{ IllegalAccessException -> 0x003e }
            java.lang.Object r4 = r0.get(r7)     // Catch:{ IllegalAccessException -> 0x003e }
            android.app.PendingIntent r4 = (android.app.PendingIntent) r4     // Catch:{ IllegalAccessException -> 0x003e }
            r0 = r14
            r1 = r15
            android.support.v4.app.NotificationCompatBase$Action r0 = readAction(r0, r1, r2, r3, r4, r5)     // Catch:{ IllegalAccessException -> 0x003e }
    ...
    private static NotificationCompatBase.Action getActionFromBundle(Bundle bundle, NotificationCompatBase.Action.Factory actionFactory, RemoteInputCompatBase.RemoteInput.Factory remoteInputFactory) {
        ...
        return actionFactory.build(bundle.getInt(KEY_ICON), bundle.getCharSequence("title"), (PendingIntent) bundle.getParcelable(KEY_ACTION_INTENT), bundle.getBundle("extras"), RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(bundle, KEY_REMOTE_INPUTS), remoteInputFactory), RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(bundle, KEY_DATA_ONLY_REMOTE_INPUTS), remoteInputFactory), allowGeneratedReplies);
    }

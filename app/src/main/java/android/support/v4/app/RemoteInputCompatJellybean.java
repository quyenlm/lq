...
class RemoteInputCompatJellybean {
    ...
    static RemoteInputCompatBase.RemoteInput fromBundle(Bundle data, RemoteInputCompatBase.RemoteInput.Factory factory) {
        ...
        return factory.build(data.getString(KEY_RESULT_KEY), data.getCharSequence("label"), data.getCharSequenceArray(KEY_CHOICES), data.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), data.getBundle("extras"), allowedDataTypes);
    }
